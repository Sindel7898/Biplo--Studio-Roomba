...
void ARoombaCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ARoombaCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ARoombaCharacter::Look);
	}
	else
	{
...
void ARoombaCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ARoombaCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
